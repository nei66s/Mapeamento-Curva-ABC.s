      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          <Card>
            ...
            <CardContent className="space-y-8">
              ...
              <section className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="item-diagnosis"
                    placeholder="Descreva os problemas encontrados, testes realizados e a causa provável da falha."
                    rows={4}
                  />
                </div>
            ...
            <CardFooter>
              <Button onClick={() => console.info('Enviar Laudo: atualmente sem integração - botão placeholder')}>
                Enviar Laudo
              </Button>
            </CardFooter>
          </Card>
